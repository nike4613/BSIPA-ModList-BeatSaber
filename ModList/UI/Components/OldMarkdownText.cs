...
namespace IPA.ModList.BeatSaber.UI.Components
{
    ...
    public class OldMarkdownText : MonoBehaviour
    {
        ...
        internal void Awake()
        {
            ...
            vpim.material = BSMLUtils.ImageResources.NoGlowMat;
            ...
            foreach (var node in doc.AsEnumerable())
            {
                ...
                if (node.Block != null)
                {
                    ...
                    { // TODO: Fix positioning
                        ...
                        im.material = BSMLUtils.ImageResources.NoGlowMat;
